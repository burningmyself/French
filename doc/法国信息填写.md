...
**护照种类:** <select name="f_identity_type" id="f_identity_type">
...
**现职业状况:** <select name="f_pers_occupation" id="f_pers_occupation">
...
**婚姻状况:** <select name="f_fami_marital_status" id="f_fami_marital_status">
    <option value="" label="请选择">请选择</option>
...
**主要目的国:** <select name="fi_trav_main_dest" id="fi_trav_main_dest" tags="destinations">
...
**请选择将要前往的法属海外省/海外领地:** <select name="overseas_territories" id="overseas_territories">
    <option value="" label="请选择">请选择</option>
...
**旅费及在国外停留期间的生活费承担方:** <select name="fi_sponsorship" id="fi_sponsorship">
    <option value="" label="请选择">请选择</option>
...
**旅费及在国外停留期间的生活费的主要支付方式:** <select name="fi_means_of_support" id="fi_means_of_support">
    <option value="" label="请选择">请选择</option>
...
**欧盟、欧洲经济区或瑞士公民的家庭成员国籍:** <select name="fi_eu_family_nationality" id="fi_eu_family_nationality" tags="eu_eea_ch">    
    <option value="" label="请选择" selected="selected">请选择</option>    
...
**与欧盟、欧洲经济区或瑞士公民的家庭成员亲属关系:** <select name="fi_eu_family_relationship" id="fi_eu_family_relationship">
    <option value="" label="请选择">请选择</option>
