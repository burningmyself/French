**<font style="font-size: 30px">法国需要填写的信息</font>**
...
**<div id="f_identity_type">护照种类:</div>** 
```html
...
**<font  id="f_pers_occupation">现职业状况:</div>** 
```html
...
**<div id="f_fami_marital_status">婚姻状况:</div>** 
```html
...
**<div id="fi_trav_main_dest">主要目的国:</div>** 
```html
...
**<div id="overseas_territories">请选择将要前往的法属海外省/海外领地:</div>** 
```html
...
<div id="dfa"><strong>法属美洲海外省:</strong></font>
```html
...
**<div id="fi_sponsorship">旅费及在国外停留期间的生活费承担方:</div>** 
```html
...
**<div id="fi_means_of_support">旅费及在国外停留期间的生活费的主要支付方式:</div>** 
```html
...
**<div id="fi_eu_family_nationality">欧盟、欧洲经济区或瑞士公民的家庭成员国籍:</div>** 
```html
...
**<div id="fi_eu_family_relationship">与欧盟、欧洲经济区或瑞士公民的家庭成员亲属关系:</div>** 
```html
